...
var _AddOption = require("./components/AddOption.js");
...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      var maxOptionPos = this.state.options.length;
      var randomNo = Math.floor(Math.random() * maxOptionPos);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(_AddOption2.default, { handleAddOption: this.handleAddOption })
      );
    }
  }]);
